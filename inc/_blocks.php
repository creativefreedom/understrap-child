...
function understrap_child_block_editor($hook) {
    wp_enqueue_script( 'understrap_child_block_variants_js', get_stylesheet_directory_uri() .  '/inc/assets/understrap_child_block_variants.js' );
}
...
function understrap_child_frontend_editor($hook) {
    wp_enqueue_style( 'understrap_child_block_variants_css', get_stylesheet_directory_uri() . '/inc/assets/understrap_child_block_variants.css' );
}
